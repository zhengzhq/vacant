...
public class VacantDepartmentController {
	...
	// page,
	// @RequestParam(value = "rows", required = false, defaultValue = "10") int
	// rows)
	...
	@RequestMapping("/in/organ/{organId}")
	@ResponseBody
	public List<VacantDepartment> getDepartmentListByOrganId(
			@PathVariable("organId") String organId) {
		return departmentService.byOrganId(organId);
	}
}
